...
template <> constexpr inline auto MainWindow::qt_create_metaobjectdata<qt_meta_tag_ZN10MainWindowE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        ...
        "onRemoteMainFrame",
        "onRemoteCameraFrame",
        "onScreenCapturerFrame",
        "frame",
        "onScreenCapturerError",
        "msg"
    };
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'onScreenCapturerFrame'
        QtMocHelpers::SlotData<void(const QImage &)>(18, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 14, 19 },
        }}),
        // Slot 'onScreenCapturerError'
...
void MainWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 14: _t->onScreenCapturerFrame((*reinterpret_cast<std::add_pointer_t<QImage>>(_a[1]))); break;
        case 15: _t->onScreenCapturerError((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
}
