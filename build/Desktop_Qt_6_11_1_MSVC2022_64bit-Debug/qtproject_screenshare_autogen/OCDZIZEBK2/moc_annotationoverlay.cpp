...
#include "../../../../src/annotation/annotationoverlay.h"
...
template <> constexpr inline auto AnnotationOverlay::qt_create_metaobjectdata<qt_meta_tag_ZN17AnnotationOverlayE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SlotData<void(const QRect &)>(26, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 27, 28 },
        }}),
        // Slot 'clearAll'
        ...
        // Slot 'addStroke'
        QtMocHelpers::SlotData<void(const Stroke &)>(32, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 6, 7 },
        }}),
        // Slot 'applyRemotePacket'
        QtMocHelpers::SlotData<void(const StrokePacket &)>(33, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
...
void AnnotationOverlay::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 6: _t->setPenColor((*reinterpret_cast<std::add_pointer_t<QColor>>(_a[1]))); break;
        case 7: _t->setPenWidth((*reinterpret_cast<std::add_pointer_t<float>>(_a[1]))); break;
        case 8: _t->setEraserMode((*reinterpret_cast<std::add_pointer_t<bool>>(_a[1]))); break;
        case 9: _t->setTextMode((*reinterpret_cast<std::add_pointer_t<bool>>(_a[1]))); break;
        case 10: _t->setFontSize((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        case 11: _t->setToolbarExcludeRect((*reinterpret_cast<std::add_pointer_t<QRect>>(_a[1]))); break;
        case 12: _t->clearAll(); break;
        case 13: _t->undo(); break;
        case 14: _t->redo(); break;
        case 15: _t->addStroke((*reinterpret_cast<std::add_pointer_t<Stroke>>(_a[1]))); break;
        case 16: _t->applyRemotePacket((*reinterpret_cast<std::add_pointer_t<StrokePacket>>(_a[1]))); break;
        case 17: _t->commitTextInput(); break;
        case 18: _t->cancelTextInput(); break;
        default: ;
        }
    }
