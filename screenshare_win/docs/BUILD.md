...
| 项 | 版本要求 | 说明 |
|------|------|------|
| **Qt** | 6.x | 需安装 `Core`、`Gui`、`Widgets`、`Multimedia` 模块 |
| **CMake** | ≥ 3.16 | 项目构建系统 |
...
项目根目录包含 `.qtcreator/` 配置，可直接在 Qt Creator 中通过"打开项目"选择 `CMakeLists.txt` 导入。调整 `SCREENSHARE_BUILD_DEBUG_WINDOWS` 后，建议重新执行一次 **Run CMake**。
...
| 文档 | 说明 |
|------|------|
| [../README.md](../README.md) | 查看项目概览与目录结构 |
