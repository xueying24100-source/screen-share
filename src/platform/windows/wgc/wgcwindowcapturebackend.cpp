...
bool WgcWindowCaptureBackend::start(HWND hwnd)
{
    ...
    try {
        ...
        // 3. 通过 interop 创建 GraphicsCaptureItem
...
QImage WgcWindowCaptureBackend::tryGetFrame()
{
    ...
    try {
        ...
        // 6. CopyResource → Map → memcpy → Unmap
