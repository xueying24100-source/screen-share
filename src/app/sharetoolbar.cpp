...
void ShareToolbar::refreshTexts()
{
    ...
    m_annotationButton->setText(m_annotationEnabled ? QStringLiteral("🖊 批注:开") : QStringLiteral("🖊 批注:关"));
    m_micButton->setText(m_micMuted ? QStringLiteral("🔇 麦克风:静音") : QStringLiteral("🎤 麦克风:开启"));
    m_systemAudioButton->setText(m_systemAudioEnabled ? QStringLiteral("🔊 共享音:开") : QStringLiteral("🔈 共享音:关"));
}
